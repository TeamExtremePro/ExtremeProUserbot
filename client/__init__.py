...
from redisdata.session import RedisSession
...
__author__ = "Aman Pandey <https://github.com/amanpandey7647>"
__copyright__ = "TG-UserBot  Copyright (C) 2021 - 2022  " + __author__
