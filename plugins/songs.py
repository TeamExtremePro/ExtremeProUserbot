...
@bot.on(amanpandey_cmd(pattern="lyrics(?: |$)(.*)", allow_sudo=True))
...
@bot.on(extremepro_cmd(pattern="song(?: |$)(.*)", outgoing=True))
@bot.on(amanpandey_cmd(pattern="song(?: |$)(.*)", allow_sudo=True))
...
@bot.on(extremepro_cmd(pattern="vsong(?: |$)(.*)", outgoing=True))
@bot.on(amanpandey_cmd(pattern="vsong(?: |$)(.*)", allow_sudo=True))
async def download_video(v_url):
    lazy = v_url
    sender = await lazy.get_sender()
    me = await lazy.client.get_me()
