...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query.startswith("`Userbot"):
            ...
            result = builder.article(
                "Source Code",
                text="**𝖂𝖊𝖑𝖈𝖔𝖒𝖊 𝖙𝖔 𝕰𝖝𝖙𝖗𝖊𝖒𝖊𝕻𝖗𝖔𝖀𝖘𝖊𝖗𝖇𝖔𝖙**\n\n`This is pmsecurity and source code of extremepro userbot to protect my master. Wait until my master approves you`\n\n" " You Have Only Time 4 To Message If You Send More then 4 time.\n\n" "My Bot Will Block You. To Avoid Spam !\n\n" "So Wait Until My Master Comes And Approves You\n\n",
                buttons=[
