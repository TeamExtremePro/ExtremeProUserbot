...
#
""" UserAndencento module for getting the weather of a city. """
...
from userAndencento import OPEN_WEATHER_MAP_APPID as OWM_API
from userAndencento.events import errors_handler, register
...
async def set_default_city(city):
    """ For .ctime command, change the default userAndencento country for date and time commands. """
