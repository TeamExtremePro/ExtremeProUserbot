...
async def wspr(event):
    ...
    Andencentousername = "@whisperBot"
    if event.reply_to_msg_id:
        reply_to_id = await event.get_reply_message()
    tap = await Andencento.inline_query(Andencentousername, wwwspr) 
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await event.edit("```Please unblock me (@FiletolinkTGAndencento) u Nigga```")
            return
        await event.delete()
    ...
    if sysarg == "":
        async with borg.conversation(Andencento) as conv:
            try:
                ...
                await event.edit("**Error:** `unblock` @spamAndencento `and retry!")
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              ...
              await event.reply("Please unblock me @SangMataInfo_Andencento")
              return
          await event.delete()
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              ...
              await event.reply("Please unblock me @chotamreaderAndencento")
              return
          await event.delete()
          await event.client.send_message(event.chat_id, response.message, reply_to=reply_message)
