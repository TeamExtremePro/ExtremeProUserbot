...
@borg.on(extremepro_cmd(pattern="run ?(.*)"))
async def _(event):
    if event.fwd_from:
         return
...
@borg.on(extremepro_cmd(pattern="metoo ?(.*)"))
async def _(event):
    if event.fwd_from:
         return
...
@borg.on(extremepro_cmd(pattern="rapee ?(.*)"))
async def _(event):
    if event.fwd_from:
         return
...
@borg.on(extremepro_cmd(pattern="insultt ?(.*)"))
async def _(event):
    if event.fwd_from:
         return
...
@borg.on(extremepro_cmd(pattern="proo ?(.*)"))
async def _(event):
    if event.fwd_from:
         return
...
@borg.on(extremepro_cmd(pattern="abusee ?(.*)"))
async def _(event):
    if event.fwd_from:
         return
...
@borg.on(extremepro_cmd(pattern="geyy ?(.*)"))
async def _(event):
    if event.fwd_from:
         return
