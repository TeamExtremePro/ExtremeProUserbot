...
@borg.on(extremepro_cmd(pattern=r"purge"))
@errors_handler
...
@borg.on(extremepro_cmd(pattern=r"purgeme"))
@errors_handler
...
@borg.on(extremepro_cmd(pattern=r"del"))
@errors_handler
...
@borg.on(extremepro_cmd(pattern=r"edit"))
@errors_handler
...
@borg.on(extremepro_cmd(pattern=r"sd"))
@errors_handler
