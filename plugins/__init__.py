...
os.system("pip install catopbolte==0.6")
import math
import os
import re
import time
...
from catopbolte.userbot import *
from catopbolte.userbot.helpers import *
from catopbolte.userbot.helpers import _cattools, _catutils, _format
