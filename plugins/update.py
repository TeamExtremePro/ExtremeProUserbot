...
from amanpandey import bot
from plugins import CMD_HELP, LOGS
...
GIT_REPO_NAME = "ExtremeProUserbo"
...
async def upstream(ups):
    ...
    if not changelog and not force_update:
        await ups.edit(
            f'\n`{JAVES_NNAME} is`  **We Are Up To Date**  \n')
        repo.__del__()
        return
    ...
    if force_update:
        ...
        await ups.edit('`updating the bot.....`')
    ...
    if HEROKU_APIKEY is not None:
        ...
        args = [sys.executable, "-m", "amanpandey"]
