...
cmd = "aria2c ExtreExtreenableExtrerpc ExtreExtrerpcExtrelistenExtreall=false ExtreExtrerpcExtrelistenExtreport 6800  ExtreExtremaxExtreconnectionExtreperExtreserver=10 ExtreExtrerpcExtremaxExtrerequestExtresize=1024M ExtreExtreseedExtretime=0.01 ExtreExtreminExtresplitExtresize=10M ExtreExtrefollowExtretorrent=mem ExtreExtresplit=10 ExtreExtredaemon=true"
